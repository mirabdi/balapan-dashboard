  ...
  return (
    <>
      ...
      {rightModal && selectedAssortment && (
        <RightModal
          title={"Ассортимент: " + selectedAssortment.title}
          afterClose={() => {
        ...
        >
          ...
          <h1 className="flex md:flex-row flex-col">
            Here will be related statistics and more info...
          </h1>
        </RightModal>
      )}
    </>
...
const getTitle = (status) => {
  switch (status) {
    case "all":
      return "Все ассортименты";
    case "active":
      return "Активные ассортименты";
    case "archived":
      return "Архивные ассортименты";
    case "catalog":
      return "Каталог";
  }
};