...
const AddProductGroup = () => {
  ...
  const handleSubmit = (event) => {
    ...
    fetch(`${BASE_URL}/products/admin-api/product-groups`, {
      method: 'POST',
      headers: {
  ...
  return (
    <>
    <Header category="Страница" title="Добавить Группу товаров" />
    <div className="max-w-md mx-auto p-8 bg-white rounded-lg shadow-md">
      <h2 className="text-xl font-semibold mb-6">Добавить Группу товаров</h2>
      <form onSubmit={handleSubmit}>
        {/* ProductGroup Name Input */}
        <div className="mb-4">
          <label htmlFor="productGroupName" className="block text-sm font-medium text-gray-700">Наименование</label>
          <input 
              type="text" 
              id="productGroupName" 
              name="productGroupName" 
