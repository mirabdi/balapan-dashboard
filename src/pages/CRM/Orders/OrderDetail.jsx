...
import { BsTelephone, BsCash } from 'react-icons/bs'; // Import telephone and cash icons from 'react-icons'
...
import {
  ...
  BsCheckCircle,
  BsXCircle,
} from 'react-icons/bs'; // Import icons from 'react-icons'
const OrderDetail = ({order}) => {
    console.log("OrderDetail", Math.random(), order)
